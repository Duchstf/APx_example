...
architecture behav of pack_out is 
    ...
    signal v2_V_fu_75_p1 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_fu_87_p5 : STD_LOGIC_VECTOR (36 downto 0);
...
begin
    ...
    data_V_data_V_din <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_fu_87_p5),96));
    ...
    v2_V_fu_75_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(outvtx_hwSumPt_V_dout),14));
end behav;
