...
# variables to change
top = 'p_T' # name of module under test; test bench is named 'tb_{}'.format(top)
...
input_vars['in_val_V'] 		= '00000000000000'  #--! input q/R
...
output_vars = [
	"ap_done", "ap_idle", "ap_ready", ("recipro_V", 13), "recipro_V_ap_vld"
]
...
with open('input_text.txt', 'w') as f:
	...
	for i in range(1, duration):
		...
		if time_elapsed == 10.0:
			input_vars['in_val_V'] = "00000000000000"

		elif time_elapsed == 10.0+3.125:
			input_vars['in_val_V'] = "11111111111111"

		elif time_elapsed == 10.0+3.125*2:
			input_vars['in_val_V'] = "11011101000100"
				
		elif time_elapsed == 10.0+3.125*3:
			input_vars['in_val_V'] = "00001101001011"

		elif time_elapsed == 10.0+3.125*4:
			input_vars['in_val_V'] = "11011010101110"

		elif time_elapsed == 10.0+3.125*5:
			input_vars['in_val_V'] = "00000000000000"

		elif time_elapsed == 10.0+3.125*6:
			input_vars['in_val_V'] = "00100111111101"

		elif time_elapsed == 10.0+3.125*7:
			input_vars['in_val_V'] = "00000101000010"

		elif time_elapsed == 10.0+3.125*8:
			input_vars['in_val_V'] = "00100100001110"

		elif time_elapsed == 10.0+3.125*9:
			input_vars['in_val_V'] = "10010101101100"

		elif time_elapsed == 10.0+3.125*10:
			input_vars['in_val_V'] = "11101101001011"

		elif time_elapsed == 10.0+3.125*11:
			input_vars['in_val_V'] = "11100111011111"

		elif time_elapsed == 10.0+3.125*12:
			input_vars['in_val_V'] = "11111111111111"

		elif time_elapsed == 10.0+3.125*13:
			input_vars['in_val_V'] = "01110011011101"

		elif time_elapsed == 10.0+3.125*14:
			input_vars['in_val_V'] = "10011001110000"
...
with open('tb_{}.vhd'.format(top), 'w') as f:
	...
	f.write('		file InF: TEXT open READ_MODE is "../../../../../../lib/hdl/tb/p_T/input_text.txt";\n')
	f.write('		file OutF: TEXT open WRITE_MODE is "../../../../../../lib/hdl/tb/p_T/output_text.txt";\n')
